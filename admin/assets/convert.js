...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const { apiFetch } = wp;
    const bcaConvertEditor = document.createElement('div');
    bcaConvertEditor.setAttribute('id', 'bcaConvertEditor');
    bcaConvertEditor.setAttribute('style', 'display: none');
    document.body.appendChild(bcaConvertEditor); 
    // $('<div />').attr('id', 'bbconv-editor').attr('style', 'display: none').appendTo('body');
    wp.editPost.initializeEditor('bcaConvertEditor');
    ...
    function convertToBlocks( post ) {
		...
		let blocks = wp.blocks.pasteHandler({ HTML: post.content });
        let promises = [];
        ...
        console.log(blocks);
        console.log(wp.blocks.serialize(blocks));
